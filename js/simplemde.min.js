    ...
    return function t(e, n, r) {
        ...
        1: [function(e, t, n) {
            (function(n) {
                ...
                CodeMirror = n.CodeMirror = e("codemirror");
                (function(e, t, n) {
                    var r, i = 0, o = !1, l = !1, a = "", s = "";
                    CodeMirror.defineMode("spell-checker", function(e, t) {
                        if (!o) {
                            ...
                            n.onload = function(e) {
                                4 === n.readyState && 200 === n.status && (a = n.responseText,
                                i++,
                                2 == i && (r = new Typo("en_US",a,s,{
                                    platform: "any"
                                })))
                            }
                            ,
                        ...
                        if (!l) {
                            ...
                            c.open("GET", "https://cdn.jsdelivr.net/codemirror.spell-checker/latest/en_US.dic", !0),
                            c.onload = function(e) {
                                4 === c.readyState && 200 === c.status && (s = c.responseText,
                                i++,
                                2 == i && (r = new Typo("en_US",a,s,{
                                    platform: "any"
                                })))
                          ...
                          , d = {
                            token: function(e, t) {
                                ...
                                if (u.includes(n))
                                    return e.next(),
                                    null ;
                                for (; null  != (n = e.peek()) && !u.includes(n); )
                                    i += n,
                                    e.next();
            ...
            (function(e) {
                (function(e, t, n, r, i) {
                    ...
                    var o = function(e, t, n, r) {
                        if (r = r || {},
                        this.platform = r.platform || "chrome",
                        ...
                        e) {
                            ...
                            "chrome" == this.platform)
                                ...
                                t || (t = this._readFile(i + "/" + e + "/" + e + ".aff")),
                                n || (n = this._readFile(i + "/" + e + "/" + e + ".dic"))
                            }
                            this.rules = this._parseAFF(t),
                            this.compoundRuleCodes = {};
                            for (var o = 0, l = this.compoundRules.length; l > o; o++)
                                for (var a = this.compoundRules[o], s = 0, c = a.length; c > s; s++)
                                    this.compoundRuleCodes[a[s]] = [];
                            "ONLYINCOMPOUND" in this.flags && (this.compoundRuleCodes[this.flags.ONLYINCOMPOUND] = []),
                            this.dictionaryTable = this._parseDIC(n);
                            for (var o in this.compoundRuleCodes)
                                0 == this.compoundRuleCodes[o].length && delete this.compoundRuleCodes[o];
                            for (var o = 0, l = this.compoundRules.length; l > o; o++) {
                    ...
                    o.prototype = {
                        ...
                        _readFile: function(e, t) {
                            ...
                            n.overrideMimeType && n.overrideMimeType("text/plain; charset=" + t),
                            n.send(null ),
                            n.responseText
                        },
                            ...
                            for (var n = e.split("\n"), r = 0, i = n.length; i > r; r++) {
                                ...
                                if ("PFX" == a || "SFX" == a) {
                                    for (var s = l[1], c = l[2], u = parseInt(l[3], 10), d = [], h = r + 1, f = r + 1 + u; f > h; h++) {
                                        ...
                                        "." !== x && ("SFX" === a ? b.match = new RegExp(x + "$") : b.match = new RegExp("^" + x)),
                                        "0" != m && ("SFX" === a ? b.remove = new RegExp(m + "$") : b.remove = m),
                                        d.push(b)
                                    }
                                    t[s] = {
                                        type: a,
                        ...
                        _applyRule: function(e, t) {
                            for (var n = t.entries, r = [], i = 0, o = n.length; o > i; i++) {
                                ...
                                if (!l.match || e.match(l.match)) {
                                    var a = e;
                                    if (l.remove && (a = a.replace(l.remove, "")),
                                    "SFX" === t.type ? a += l.add : a = l.add + a,
                                    r.push(a),
                                    "continuationClasses" in l)
                        ...
                        suggest: function(e, t) {
                            function n(e) {
                                for (var t = [], n = 0, r = e.length; r > n; n++) {
                                    for (var i = e[n], o = [], l = 0, a = i.length + 1; a > l; l++)
                                        o.push([i.substring(0, l), i.substring(l, i.length)]);
                                    ...
                                    for (var h = [], l = 0, a = o.length; a > l; l++) {
                                        var u = o[l];
                                        if (u[1])
                                            for (var f = 0, p = c.alphabet.length; p > f; f++)
                                                h.push(u[0] + c.alphabet[f] + u[1].substring(1))
                                    }
                                    for (var m = [], l = 0, a = o.length; a > l; l++) {
                                        var u = o[l];
                                        if (u[1])
                                            for (var f = 0, p = c.alphabet.length; p > f; f++)
                                                h.push(u[0] + c.alphabet[f] + u[1])
                                    }
                                    t = t.concat(s),
                                    t = t.concat(d),
                                    t = t.concat(h),
                            ...
                            function i(e) {
                                ...
                                for (var o = n([e]), l = n(o), a = r(o).concat(r(l)), s = {}, u = 0, d = a.length; d > u; u++)
                                    a[u] in s ? s[a[u]] += 1 : s[a[u]] = 1;
                                var h = [];
                                for (var u in s)
                                    h.push([u, s[u]]);
                                h.sort(i).reverse();
                                for (var f = [], u = 0, d = Math.min(t, h.length); d > u; u++)
                                    c.hasFlag(h[u][0], "NOSUGGEST") || f.push(h[u][0]);
                                return f
                            }
                            if (t || (t = 5),
                            this.check(e))
            ...
            !function(t) {
                ...
                function e(n, r) {
                    if (!(this instanceof e))
                        return new e(n,r);
                    this.options = r = r ? Fi(r) : {},
                    Fi(Jo, r, !1),
                    f(r);
                    var i = r.value;
                    "string" == typeof i && (i = new Cl(i,r.mode,null ,r.lineSeparator)),
                    this.doc = i;
                    ...
                    Yr(this, i),
                    r.autofocus && !Ao || s.hasFocus() ? setTimeout(zi(vn, this), 20) : yn(this);
                    for (var u in el)
                        el.hasOwnProperty(u) && el[u](this, r[u], tl);
                    k(this),
                    r.finishInit && r.finishInit(this);
                    for (var d = 0; d < ol.length; ++d)
                        ol[d](this);
                    kt(this),
                    wo && r.lineWrapping && "optimizelegibility" == getComputedStyle(l.lineDiv).textRendering && (l.lineDiv.style.textRendering = "auto")
                }
                function t(e, t, n) {
                    var r = this;
                    this.input = n,
                    ...
                    r.sizerWidth = null ,
                    r.heightForcer = _i("div", null , null , "position: absolute; height: " + El + "px; width: 1px;"),
                ...
                function i(e) {
                    e.options.lineWrapping ? (Zl(e.display.wrapper, "CodeMirror-wrap"),
                    e.display.sizer.style.minWidth = "",
                    e.display.sizerWidth = null ) : (Yl(e.display.wrapper, "CodeMirror-wrap"),
                    h(e)),
                    l(e),
                    Dt(e),
                    at(e),
                ...
                function f(e) {
                    var t = Ii(e.gutters, "CodeMirror-linenumbers");
                ...
                function v(t) {
                    ...
                    t.display.scrollbars.addClass && Yl(t.display.wrapper, t.display.scrollbars.addClass)),
                    ...
                    ,t),
                    t.display.scrollbars.addClass && Zl(t.display.wrapper, t.display.scrollbars.addClass)
                }
                function y(e, t) {
                    t || (t = p(e));
                    ...
                    for (var i = 0; 4 > i && n != e.display.barWidth || r != e.display.barHeight; i++)
                        n != e.display.barWidth && e.options.lineWrapping && H(e),
                        x(e, p(e)),
                ...
                function b(e, t, n) {
                    ...
                    if (n && n.ensure) {
                        var a = n.ensure.from.line
                          , s = n.ensure.to.line;
                        o > a ? (o = a,
                        l = ni(t, ri(Zr(t, a)) + e.wrapper.clientHeight)) : Math.min(s, t.lastLine()) >= l && (o = ni(t, ri(Zr(t, s)) - e.wrapper.clientHeight),
                        l = s)
                    }
                    return {
                        from: o,
                ...
                function T(e) {
                    ...
                    t.heightForcer.style.height = $e(e) + "px",
                    t.sizer.style.marginBottom = -t.nativeBarWidth + "px",
                    t.sizer.style.borderRightWidth = $e(e) + "px",
                ...
                function M(e, t) {
                    ...
                    if (t.editorIsHidden)
                        return Ft(e),
                        !1;
                    if (!t.force && t.visible.from >= n.viewFrom && t.visible.to <= n.viewTo && (null  == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo) && n.renderedView == n.view && 0 == jt(e))
                        return !1;
                    k(e) && (Ft(e),
                    t.dims = I(e));
                    ...
                    var s = jt(e);
                    if (!a && 0 == s && !t.force && n.renderedView == n.view && (null  == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo))
                        return !1;
                    var c = Gi();
                ...
                function N(e, t) {
                    for (var n = t.viewport, r = !0; (r && e.options.lineWrapping && t.oldDisplayWidth != Ve(e) || (n && null  != n.top && (n = {
                ...
                function O(e, t) {
                    ...
                    e.display.gutters.style.height = Math.max(t.docHeight + e.display.barHeight + $e(e), t.clientHeight) + "px"
                }
                function H(e) {
                ...
                function E(e, t, n) {
                    function r(t) {
                        var n = t.nextSibling;
                        return wo && Oo && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t),
                        n
                    }
                    for (var i = e.display, o = e.options.lineNumbers, l = i.lineDiv, a = l.firstChild, s = i.view, c = i.viewFrom, u = 0; u < s.length; u++) {
                        ...
                        if (d.hidden)
                            ...
                            d.changes && (Ii(d.changes, "gutter") > -1 && (h = !1),
                            D(e, d, c, n)),
                            h && (qi(d.lineNumber),
                            d.lineNumber.appendChild(document.createTextNode(C(e.options, c)))),
                ...
                function j(e, t, n, r) {
                    ...
                    if (e.options.lineNumbers || o) {
                        ...
                        !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(_i("div", C(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                        o)
                        ...
                        if (Ro && Ro.join("\n") == t) {
                            if (r.ranges.length % Ro.length == 0) {
                                ...
                                for (var c = 0; c < Ro.length; c++)
                                    s.push(o.splitLines(Ro[c]))
                            }
                        } else
                            a.length == r.ranges.length && (s = Ei(a, function(e) {
                                return [e]
                            }));
                        ...
                        for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                            ...
                            if (!(i.head.ch > 100 || r && n.ranges[r - 1].head.line == i.head.line)) {
                                ...
                                if (o.electricChars) {
                                    ...
                                    o.electricInput && o.electricInput.test(Zr(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Bn(e, i.head.line, "smart"));
                ...
                function ae(e, t, n) {
                    ...
                    if (t == e.display.lineDiv) {
                        ...
                        !r)
                            return le(e.clipPos(Fo(e.display.viewTo - 1)), !0);
                        t = null ,
                        n = 0
                    } else
                ...
                function se(e, t, n) {
                    ...
                    n && (n = a.nodeValue.length)); s.parentNode != i; )
                        s = s.parentNode;
                    var c = e.measure
                      , u = c.maps
                      , d = r(a, s, n);
                ...
                function ce(e, t, n, r, i) {
                    ...
                    for (var a = "", s = !1, c = e.doc.lineSeparator(); l(t),
                    t != n; )
                        t = t.nextSibling;
                    return a
                }
                ...
                function he(e, t) {
                    ...
                    for (var r = 1; r < e.length; r++) {
                        ...
                        if (zo(o.to(), i.from()) >= 0) {
                            ...
                            t >= r && --t,
                            e.splice(--r, 2, new de(s ? a : l,s ? l : a))
                        }
                    }
                    return new ue(e,t)
                }
                ...
                function Se(e, t, n) {
                    ...
                    return Wl(e, "beforeSelectionChange", e, r),
                    e.cm && Wl(e.cm, "beforeSelectionChange", e.cm, r),
                ...
                function Te(e, t, n) {
                    Me(e, t, n),
                    di(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n)
                }
                function Me(e, t, n) {
                ...
                function Oe(e, t, n, r) {
                    for (var i, o = 0; o < t.ranges.length; o++) {
                        ...
                        (i || s != l.anchor || c != l.head) && (i || (i = t.ranges.slice(0, o)),
                        i[o] = new de(s,c))
                    }
                        ...
                        for (var l = 0; l < o.markedSpans.length; ++l) {
                            ...
                            if ((null  == a.from || (s.inclusiveLeft ? a.from <= t.ch : a.from < t.ch)) && (null  == a.to || (s.inclusiveRight ? a.to >= t.ch : a.to > t.ch))) {
                                ...
                                if (!s.atomic)
                                    ...
                                    if ((0 > r ? s.inclusiveRight : s.inclusiveLeft) && (u = Ie(e, u, -r, u && u.line == t.line ? o : null )),
                                    u && u.line == t.line && (c = zo(u, n)) && (0 > r ? 0 > c : c > 0))
                                        return He(e, u, t, r, i)
                                }
                                var d = s.find(0 > r ? -1 : 1);
                                return (0 > r ? s.inclusiveLeft : s.inclusiveRight) && (d = Ie(e, d, r, d.line == t.line ? o : null )),
                                d ? He(e, d, t, r, i) : null 
                            }
                        }
                    return t
                    ...
                    for (var n = e.doc, r = {}, i = r.cursors = document.createDocumentFragment(), o = r.selection = document.createDocumentFragment(), l = 0; l < n.sel.ranges.length; l++)
                        if (t !== !1 || l != n.sel.primIndex) {
                            ...
                            if (!(a.from().line >= e.display.viewTo || a.to().line < e.display.viewFrom)) {
                                var s = a.empty();
                                (s || e.options.showCursorWhenSelecting) && Pe(e, a.head, i),
                                s || Fe(e, a, o)
                            }
                        }
                    return r
                ...
                function Fe(e, t, n) {
                    function r(e, t, n, r) {
                        ...
                        t = Math.round(t),
                        r = Math.round(r),
                        a.appendChild(_i("div", null , "CodeMirror-selected", "position: absolute; left: " + e + "px; top: " + t + "px; width: " + (null  == n ? u - e : n) + "px; height: " + (r - t) + "px"))
                    }
                    function i(t, n, i) {
                        function o(n, r) {
                            return ht(e, Fo(t, n), "div", d, r)
                        }
                        var a, s, d = Zr(l, t), h = d.text.length;
                        return eo(ii(d), n || 0, null  == i ? h : i, function(e, t, l) {
                            ...
                            null  == n && 0 == e && (f = c),
                            d.top - m.top > 3 && (r(f, m.top, null , m.bottom),
                            f = c,
                            m.bottom < d.top && r(f, m.bottom, null , d.top)),
                            null  == i && t == h && (p = u),
                            (!a || m.top < a.top || m.top == a.top && m.left < a.left) && (a = m),
                            (!s || d.bottom > s.bottom || d.bottom == s.bottom && d.right > s.right) && (s = d),
                            c + 1 > f && (f = c),
                            r(f, d.top, p - f, d.bottom)
                        }),
                        {
                            start: a,
                            end: s
                    ...
                    !(t.frontier >= e.display.viewTo)) {
                        ...
                        t.iter(t.frontier, Math.min(t.first + t.size, e.display.viewTo + 500), function(o) {
                            if (t.frontier >= e.display.viewFrom) {
                                ...
                                for (var d = !l || l.length != o.styles.length || c != u && (!c || !u || c.bgClass != u.bgClass || c.textClass != u.textClass), h = 0; !d && h < l.length; ++h)
                                    d = l[h] != o.styles[h];
                                d && i.push(t.frontier),
                                o.stateAfter = a ? r : al(t.mode, r)
                            } else
                                o.text.length <= e.options.maxHighlightLength && Pr(e, o.text, r),
                                o.stateAfter = t.frontier % 5 == 0 ? al(t.mode, r) : null ;
                            return ++t.frontier,
                ...
                function je(e, t, n) {
                    for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), a = t; a > l; --a) {
                        if (a <= o.first)
                            return o.first;
                        var s = Zr(o, a - 1);
                        if (s.stateAfter && (!n || a <= o.frontier))
                            return a;
                ...
                function _e(e, t, n) {
                    ...
                    return l = l ? al(r.mode, l) : sl(r.mode),
                    r.iter(o, t, function(n) {
                        Pr(e, n.text, l);
                        var a = o == t - 1 || o % 5 == 0 || o >= i.viewFrom && o < i.viewTo;
                        n.stateAfter = a ? al(r.mode, l) : null ,
                        ++o
                    }),
                    n && (r.frontier = o),
                    l
                ...
                function Ze(e, t) {
                    ...
                    return r.text = i.pre,
                    Ui(e.display.lineMeasure, i.pre),
                    r
                }
                function Qe(e, t, n, r) {
                ...
                function et(e, t) {
                    var n = ti(t)
                      , r = Je(e, n);
                    r && !r.text ? r = null  : r && r.changes && (D(e, r, n, I(e)),
                ...
                function tt(e, t, n, r, i) {
                    ...
                    t.hasHeights || (Xe(e, t.view, t.rect),
                    t.hasHeights = !0),
                    o = rt(e, t, n, r),
                    o.bogus || (t.cache[l] = o)),
                    {
                ...
                function nt(e, t, n) {
                    for (var r, i, o, l, a = 0; a < e.length; a += 3) {
                        ...
                        o = 1,
                        l = "left") : c > t ? (i = t - s,
                        o = i + 1) : (a == e.length - 3 || t == c && e[a + 3] > t) && (o = c - s,
                        i = o - 1,
                        t >= c && (l = "right")),
                        null  != i) {
                            if (r = e[a + 2],
                            s == c && n == (r.insertLeft ? "left" : "right") && (l = n),
                            "left" == n && 0 == i)
                ...
                function rt(e, t, n, r) {
                    ...
                    if (3 == l.nodeType) {
                        for (var u = 0; 4 > u; u++) {
                            for (; a && ji(t.line.text.charAt(o.coverStart + a)); )
                                --a;
                            for (; o.coverStart + s < o.coverEnd && ji(t.line.text.charAt(o.coverStart + s)); )
                                ++s;
                            if (xo && 9 > bo && 0 == a && s == o.coverEnd - o.coverStart)
                                ...
                                i = ql(l, a, s).getBoundingClientRect() || qo;
                ...
                function ut(e, t, n, r) {
                    ...
                    r || (r = "local");
                    var l = ri(t);
                    if ("local" == r ? l += qe(e.display) : l -= e.display.viewOffset,
                    "page" == r || "window" == r) {
                ...
                function gt(e, t, n) {
                    ...
                    for (var l = Zr(r, i); ; ) {
                        var a = vt(e, l, i, t, n)
                          , s = gr(l)
                          , c = s && s.find(0, !0);
                        if (!s || !(a.ch > c.from.ch || a.ch == c.from.ch && a.xRel > 0))
                            return a;
                        i = ti(l = c.to.line)
                    }
                }
                function vt(e, t, n, r, i) {
                    function o(r) {
                        ...
                        return a = !0,
                        l > i.bottom ? i.left - s : l < i.top ? i.left + s : (a = !1,
                        i.left)
                    }
                    var l = i - ri(t)
                      , a = !1
                    ...
                    for (; ; ) {
                        if (u ? f == h || f == ho(t, h, 1) : 1 >= f - h) {
                            for (var y = p > r || g - r >= r - p ? h : f, x = r - (y == h ? p : g); ji(t.text.charAt(y)); )
                                ++y;
                ...
                function Tt(e) {
                    var t = e.cm
                      , n = t.display;
                    e.updatedDisplay && H(t),
                    e.barMeasure = p(t),
                    n.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = Qe(t, n.maxLine, n.maxLine.text.length).left + 3,
                    t.display.sizerWidth = e.adjustWidthTo,
                    e.barMeasure.scrollWidth = Math.max(n.scroller.clientWidth, n.sizer.offsetLeft + e.adjustWidthTo + $e(t) + t.display.barWidth),
                    e.maxScrollLeft = Math.max(0, n.sizer.offsetLeft + e.adjustWidthTo - Ve(t))),
                ...
                function Mt(e) {
                    ...
                    e.updatedDisplay && O(t, e.barMeasure),
                    (e.updatedDisplay || e.startHeight != t.doc.height) && y(t, e.barMeasure),
                    e.selectionChanged && ze(t),
                    t.state.focused && e.updateInput && t.display.input.reset(e.typing),
                    !e.focus || e.focus != Gi() || document.hasFocus && !document.hasFocus() || Y(e.cm)
                }
                function Nt(e) {
                    var t = e.cm
                      , n = t.display
                    ...
                    if (o)
                        for (var a = 0; a < o.length; ++a)
                            o[a].lines.length || Wl(o[a], "hide");
                    if (l)
                        for (var a = 0; a < l.length; ++a)
                            l[a].lines.length && Wl(l[a], "unhide");
                    n.wrapper.offsetHeight && (r.scrollTop = t.display.scroller.scrollTop),
                    e.changeObjs && Wl(t, "changes", t, e.changeObjs),
                ...
                function It(e, t, n) {
                    this.line = t,
                    this.rest = xr(t),
                    this.size = this.rest ? ti(Wi(this.rest)) - n + 1 : 1,
                ...
                function Dt(e, t, n, r) {
                    ...
                    t >= i.viewTo)
                        Po && br(e.doc, t) < i.viewTo && Ft(e);
                    else if (n <= i.viewFrom)
                        Po && wr(e.doc, n + r) > i.viewFrom ? Ft(e) : (i.viewFrom += r,
                        i.viewTo += r);
                        ...
                        i.viewTo = o.lineN) : Ft(e)
                    } else {
                        var l = Rt(e, t, t, -1)
                          , a = Rt(e, n, n + r, 1);
                        l && a ? (i.view = i.view.slice(0, l.index).concat(Et(e, l.lineN, a.lineN)).concat(i.view.slice(a.index)),
                        i.viewTo += r) : Ft(e)
                    }
                ...
                function Rt(e, t, n, r) {
                    ...
                    if (!Po || n == e.doc.first + e.doc.size)
                        return {
                            index: o,
                            lineN: n
                        };
                    for (var a = 0, s = e.display.viewFrom; o > a; a++)
                        s += l[a].size;
                    if (s != t) {
                        if (r > 0) {
                            if (o == l.length - 1)
                    ...
                    for (; br(e.doc, n) != n; ) {
                        if (o == (0 > r ? 0 : l.length - 1))
                            return null ;
                        n += r * l[o - (0 > r ? 1 : 0)].size,
                        o += r
                    }
                    return {
                        index: o,
                ...
                function Bt(e, t, n) {
                    var r = e.display
                      , i = r.view;
                    0 == i.length || t >= r.viewTo || n <= r.viewFrom ? (r.view = Et(e, t, n),
                    r.viewFrom = t) : (r.viewFrom > t ? r.view = Et(e, t, r.viewFrom).concat(r.view) : r.viewFrom < t && (r.view = r.view.slice(zt(e, t))),
                    r.viewFrom = t,
                    r.viewTo < n ? r.view = r.view.concat(Et(e, r.viewTo, n)) : r.viewTo > n && (r.view = r.view.slice(0, zt(e, n)))),
                    r.viewTo = n
                }
                function jt(e) {
                ...
                function _t(e) {
                    ...
                    var i = e.display;
                    Al(i.scroller, "mousedown", Ot(e, Vt)),
                    xo && 11 > bo ? Al(i.scroller, "dblclick", Ot(e, function(t) {
                        if (!Ti(e, t)) {
                            var n = $t(e, t);
                    ...
                    Al(i.scroller, "touchend", function(n) {
                        ...
                        if (o && !Gt(i, n) && null  != o.left && !o.moved && new Date - o.start < 300) {
                            ...
                            l = !o.prev || r(o, o.prev) ? new de(a,a) : !o.prev.prev || r(o, o.prev.prev) ? e.findWordAt(a) : new de(Fo(a.line, 0),me(e.doc, Fo(a.line + 1, 0))),
                    ...
                    Al(i.scroller, "touchcancel", t),
                    Al(i.scroller, "scroll", function() {
                    ...
                    Al(a, "keydown", Ot(e, hn)),
                    Al(a, "keypress", Ot(e, mn)),
                    Al(a, "focus", zi(vn, e)),
                    Al(a, "blur", zi(yn, e))
                }
                function qt(t, n, r) {
                    ...
                    if (!n != !i) {
                        ...
                        l(t.display.scroller, "dragenter", o.enter),
                        l(t.display.scroller, "dragover", o.over),
                        l(t.display.scroller, "dragleave", o.leave),
                ...
                function Kt(e, t, n) {
                    ...
                    var r, i = +new Date;
                    _o && _o.time > i - 400 && 0 == zo(_o.pos, n) ? r = "triple" : jo && jo.time > i - 400 && 0 == zo(jo.pos, n) ? (r = "double",
                    _o = {
                        time: i,
                        pos: n
                    }) : (r = "single",
                    ...
                    var o, l = e.doc.sel, a = Oo ? t.metaKey : t.ctrlKey;
                ...
                function Xt(e, t, n, r) {
                    var i = e.display
                      ...
                      , l = Ot(e, function(a) {
                        ...
                        Hl(document, "mouseup", l),
                        Hl(i.scroller, "drop", l),
                        Math.abs(t.clientX - a.clientX) + Math.abs(t.clientY - a.clientY) < 10 && (Tl(a),
                ...
                function Yt(e, t, n, r, i) {
                    function o(t) {
                        if (0 != zo(g, t))
                            ...
                            "rect" == r) {
                                ...
                                Te(c, he(h.ranges.slice(0, d).concat(i), d), {
                                    origin: "*mouse",
                                    scroll: !1
                                }),
                                e.scrollIntoView(t)
                                ...
                                if ("single" != r) {
                                    if ("double" == r)
                                        ...
                                        var k = new de(Fo(t.line, 0),me(c, Fo(t.line + 1, 0)));
                                    zo(k.anchor, b) > 0 ? (w = k.head,
                                    b = X(x.from(), k.anchor)) : (w = k.anchor,
                                    b = K(x.to(), k.head))
                                }
                    ...
                    function a(t) {
                        ...
                        Tl(t),
                        s.input.focus(),
                        Hl(document, "mousemove", x),
                        Hl(document, "mouseup", w),
                    ...
                    if (i && !t.shiftKey ? (d = c.sel.contains(n),
                    u = d > -1 ? f[d] : new de(n,n)) : (u = c.sel.primary(),
                    d = c.sel.primIndex),
                    t.altKey)
                        r = "rect",
                        i || (u = new de(n,n)),
                    ...
                    Al(document, "mousemove", x),
                    Al(document, "mouseup", w)
                }
                function Zt(e, t, n, r) {
                    try {
                        var i = t.clientX
                        ...
                        if (n && !t.isReadOnly())
                            if (r && r.length && window.FileReader && window.File)
                                ...
                                try {
                                    ...
                                    if (o) {
                                        if (t.state.draggingText && !(Oo ? e.altKey : e.ctrlKey))
                                            var c = t.listSelections();
                                        if (Me(t.doc, fe(n, n)),
                                        c)
                                            for (var s = 0; s < c.length; ++s)
                                                Wn(t.doc, "", c[s].anchor, c[s].head, "drag");
                ...
                function tn(e, t) {
                    ...
                    if (n) {
                        ...
                        Pe(e, n, r),
                        e.display.dragCursor || (e.display.dragCursor = _i("div", null , "CodeMirror-cursors CodeMirror-dragcursors"),
                        e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)),
                        Ui(e.display.dragCursor, r)
                    }
                }
                function nn(e) {
                ...
                function ln(e, t) {
                    ...
                    if (r && a || i && s) {
                        ...
                        if (r && !go && !So && null  != Ko)
                            return i && s && rn(e, Math.max(0, Math.min(l.scrollTop + i * Ko, l.scrollHeight - l.clientHeight))),
                            on(e, Math.max(0, Math.min(l.scrollLeft + r * Ko, l.scrollWidth - l.clientWidth))),
                            (!i || i && s) && Tl(t),
                        ...
                        20 > Vo && (null  == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
                ...
                function cn(e, t, n, r) {
                    ...
                    "handled" == o && Si(e, "keyHandled", e, t, n),
                    "handled" != o && "multi" != o || (Tl(n),
                    ze(e)),
                    i && !o && /\'$/.test(t) ? (Tl(n),
                    !0) : !!o
                }
                ...
                function hn(e) {
                    ...
                    !Ti(t, e)) {
                        ...
                        var r = un(t, e);
                        So && (Zo = r ? n : null ,
                        !r && 88 == n && !na && (Oo ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null , "cut")),
                        18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || fn(t)
                    }
                }
                function fn(e) {
                    function t(e) {
                        18 != e.keyCode && e.altKey || (Yl(n, "CodeMirror-crosshair"),
                        Hl(document, "keyup", t),
                        Hl(document, "mouseover", t))
                    }
                    var n = e.display.lineDiv;
                    Zl(n, "CodeMirror-crosshair"),
                    Al(document, "keyup", t),
                ...
                function vn(e) {
                    e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1),
                    "nocursor" != e.options.readOnly && (e.state.focused || (Wl(e, "focus", e),
                    e.state.focused = !0,
                    Zl(e.display.wrapper, "CodeMirror-focused"),
                ...
                function yn(e) {
                    e.state.delayingBlurEvent || (e.state.focused && (Wl(e, "blur", e),
                    e.state.focused = !1,
                    Yl(e.display.wrapper, "CodeMirror-focused")),
                ...
                function Ln(e, t, n) {
                    ...
                    Wl(e, "beforeChange", e, r),
                    e.cm && Wl(e.cm, "beforeChange", e.cm, r),
                    r.canceled ? null  : {
                        from: r.from,
                        to: r.to,
                        text: r.text,
                ...
                function Mn(e, t) {
                    if (1 != t.text.length || "" != t.text[0] || 0 != zo(t.from, t.to)) {
                        ...
                        var r = [];
                        Xr(e, function(e, n) {
                            n || -1 != Ii(r, e.history) || (xi(e.history, t),
                            r.push(e.history)),
                            On(e, t, null , or(e, t))
                        })
                    }
                ...
                function Nn(e, t, n) {
                    if (!e.cm || !e.cm.state.suppressEdits) {
                        ...
                        n ? !r.ranges || r.equals(e.sel) : r.ranges); s++)
                            ;
                        if (s != l.length) {
                            for (i.lastOrigin = i.lastSelOrigin = null ; r = l.pop(),
                            r.ranges; ) {
                                if (hi(r, a),
                                n && !r.equals(e.sel))
                                    return void Te(e, r, {
                            ...
                            for (var u = Ni(e, "beforeChange") || e.cm && Ni(e.cm, "beforeChange"), s = r.changes.length - 1; s >= 0; --s) {
                                ...
                                var f = [];
                                Xr(e, function(e, t) {
                                    t || -1 != Ii(f, e.history) || (xi(e.history, d),
                                    f.push(e.history)),
                                    On(e, d, null , ar(e, d))
                                })
                            }
                ...
                function An(e, t) {
                    if (0 != t && (e.first += t,
                    e.sel = new ue(Ei(e.sel.ranges, function(e) {
                ...
                function On(e, t, n, r) {
                    ...
                    if (!(t.from.line > e.lastLine())) {
                        ...
                        t.removed = Qr(e, t.from, t.to),
                        n || (n = kn(e, t)),
                        e.cm ? Hn(e.cm, t, r) : $r(e, t, r),
                        Me(e, n, Pl)
                    }
                }
                function Hn(e, t, n) {
                    var r = e.doc
                      ...
                      , s = !1
                      , c = l.line;
                    e.options.lineWrapping || (c = ti(yr(Zr(r, l.line))),
                    r.iter(c, a.line + 1, function(e) {
                        return e == i.maxLine ? (s = !0,
                        !0) : void 0
                    })),
                    r.sel.contains(t.from, t.to) > -1 && Mi(e),
                    $r(r, t, n, o(e)),
                    e.options.lineWrapping || (r.iter(c, l.line + t.text.length, function(e) {
                        var t = d(e);
                    ...
                    r.frontier = Math.min(r.frontier, l.line),
                    Re(e, 400);
                ...
                function zn(e) {
                    ...
                    var t = e.getCursor()
                      , n = t
                      , r = t;
                    e.options.lineWrapping || (n = t.ch ? Fo(t.line, t.ch - 1) : t,
                    r = Fo(t.line, t.ch + 1)),
                    e.curOp.scrollToPos = {
                        from: n,
                        to: r,
                ...
                function Bn(e, t, n, r) {
                    var i, o = e.doc;
                    null  == n && (n = "add"),
                    "smart" == n && (o.mode.indent ? i = _e(e, t) : n = "prev");
                    ...
                    if (r || /\S/.test(a.text)) {
                        if ("smart" == n && (c = o.mode.indent(i, a.text.slice(u.length), a.text),
                        c == Dl || c > 150)) {
                            if (!r)
                                return;
                            n = "prev"
                        ...
                        c = 0,
                        n = "not";
                    "prev" == n ? c = t > o.first ? Rl(Zr(o, t - 1).text, null , l) : 0 : "add" == n ? c = s + e.options.indentUnit : "subtract" == n ? c = s - e.options.indentUnit : "number" == typeof n && (c = s + n),
                    c = Math.max(0, c);
                    var d = ""
                      , h = 0;
                    ...
                    if (c > h && (d += Hi(c - h)),
                    d != u)
                        return Wn(o, d, Fo(t, 0), Fo(t, u.length), "+input"),
                        a.stateAfter = null ,
                        !0;
                ...
                function jn(e, t, n, r) {
                    ...
                    null  == i ? null  : (r(o, i) && e.cm && Pt(e.cm, i, n),
                    o)
                }
                function _n(e, t) {
                    ...
                    At(e, function() {
                        for (var t = r.length - 1; t >= 0; t--)
                            Wn(e.doc, "", r[t].from, r[t].to, "+delete");
                        zn(e)
                    })
                }
                function qn(e, t, n, r, i) {
                    function o() {
                        var t = a + n;
                        return t < e.first || t >= e.first + e.size ? !1 : (a = t,
                        u = Zr(e, t))
                    }
                    function l(e) {
                ...
                function Kn(e, t, n, r, i) {
                    if (r && r.shared)
                        return Xn(e, t, n, r, i);
                    if (e.cm && !e.cm.curOp)
                        return Ot(e.cm, Kn)(e, t, n, r, i);
                    var o = new gl(e,i)
                      , l = zo(t, n);
                    if (r && Fi(r, o, !1),
                    l > 0 || 0 == l && o.clearWhenEmpty !== !1)
                        return o;
                    ...
                    if (e.iter(s, n.line + 1, function(e) {
                        c && o.collapsed && !c.options.lineWrapping && yr(e) == c.display.maxLine && (a = !0),
                        o.collapsed && s != t.line && ei(e, 0),
                        nr(e, new Jn(o,s == t.line ? t.ch : null ,s == n.line ? n.ch : null )),
                        ++s
                    }),
                ...
                function or(e, t) {
                    ...
                    if (!c) {
                        ...
                        if (g > 0 && a)
                            for (var d = 0; d < a.length; ++d)
                                null  == a[d].to && (m || (m = [])).push(new Jn(a[d].marker,null ,null ));
                        for (var d = 0; g > d; ++d)
                            p.push(m);
                        p.push(s)
                    }
                ...
                function pr(e, t) {
                    ...
                    if (r)
                        for (var i, o = 0; o < r.length; ++o)
                            i = r[o],
                            i.marker.collapsed && null  == (t ? i.from : i.to) && (!n || fr(n, i.marker) < 0) && (n = i.marker);
                    return n
                }
                function mr(e) {
                    return pr(e, !0)
                    ...
                    if (l)
                        for (var a = 0; a < l.length; ++a) {
                            ...
                            if (s.marker.collapsed) {
                                ...
                                if (!(u >= 0 && 0 >= d || 0 >= u && d >= 0) && (0 >= u && (zo(c.to, n) > 0 || s.marker.inclusiveRight && i.inclusiveLeft) || u >= 0 && (zo(c.from, r) < 0 || s.marker.inclusiveLeft && i.inclusiveRight)))
                                    return !0
                            }
                        }
                }
                    ...
                    if (n)
                        for (var r, i = 0; i < n.length; ++i)
                            ...
                            r.marker.collapsed) {
                                if (null  == r.from)
                                    return !0;
                                if (!r.marker.widgetNode && 0 == r.from && r.marker.inclusiveLeft && Cr(e, t, r))
                                    return !0
                            }
                }
                function Cr(e, t, n) {
                    ...
                    for (var i, o = 0; o < t.markedSpans.length; ++o)
                        ...
                        i.marker.collapsed && !i.marker.widgetNode && i.from == n.to && (null  == i.to || i.to != n.from) && (i.marker.inclusiveLeft || n.marker.inclusiveRight) && Cr(e, t, i))
                            return !0
                }
                function Sr(e, t, n) {
                ...
                function Lr(e) {
                    ...
                    if (!Vl(document.body, e.node)) {
                        ...
                        Ui(t.display.measure, _i("div", [e.node], null , n))
                    }
                ...
                function Wr(e, t, n, r) {
                    ...
                    t = me(l, t);
                    var s, c = Zr(l, t.line), u = _e(e, t.line, n), d = new pl(c.text,e.options.tabSize);
                    for (r && (s = []); (r || d.pos < t.ch) && !d.eol(); )
                        d.start = d.pos,
                        o = Hr(a, d, u),
                        r && s.push(i(!0));
                    return r ? s : i()
                ...
                function Ir(e, t, n, r, i, o, l) {
                    ...
                    var s, c = 0, u = null , d = new pl(t,e.options.tabSize), h = e.options.addModeClass && [null ];
                    for ("" == t && Ar(Or(n, r), o); !d.eol(); ) {
                        if (d.pos > e.options.maxHighlightLength ? (a = !1,
                        l && Pr(e, t, r, d.pos),
                        d.pos = t.length,
                        s = null ) : s = Ar(Hr(n, d, r, h), o),
                        h) {
                            var f = h[0].name;
                            f && (s = "m-" + (s ? f + " " + s : f))
                        }
                ...
                function zr(e, t) {
                    ...
                    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                        ...
                        r.pos = 0,
                        r.addToken = Br,
                        Qi(e.display.measure) && (o = ii(l)) && (r.addToken = _r(r.addToken, o)),
                        r.map = [];
                        var a = t != e.display.externalMeasured && ti(l);
                        Ur(l, r, Dr(e, l, a)),
                        l.styleClasses && (l.styleClasses.bgClass && (r.bgClass = Vi(l.styleClasses.bgClass, r.bgClass || "")),
                        l.styleClasses.textClass && (r.textClass = Vi(l.styleClasses.textClass, r.textClass || ""))),
                    ...
                    Wl(e, "renderLine", e, t.line, r.pre),
                    r.pre.className && (r.textClass = Vi(r.pre.className, r.textClass || "")),
                    r
                }
                function Rr(e) {
                        ...
                        if (s.test(t))
                            for (var u = document.createDocumentFragment(), d = 0; ; ) {
                                ...
                                if (f) {
                                    ...
                                    xo && 9 > bo ? u.appendChild(_i("span", [p])) : u.appendChild(p),
                ...
                function _r(e, t) {
                    return function(n, r, i, o, l, a, s) {
                        ...
                        for (var c = n.pos, u = c + r.length; ; ) {
                            ...
                            e(n, r.slice(0, h.to - c), i, o, null , a, s),
                            o = null ,
                            r = r.slice(h.to - c),
                            c = h.to
                        }
                        ...
                        for (var l, a, s, c, u, d, h, f = i.length, p = 0, m = 1, g = "", v = 0; ; ) {
                            if (v == p) {
                                ...
                                for (var y, x = [], b = 0; b < r.length; ++b) {
                                    ...
                                    k.title && !d && (d = k.title),
                                    k.collapsed && (!h || fr(h.marker, k) < 0) && (h = w)) : w.from > p && v > w.from && (v = w.from)
                                }
                                if (y)
                                ...
                                if (!h || h.from == p)
                                    for (var b = 0; b < x.length; ++b)
                                        qr(t, 0, x[b]);
                                if (h && (h.from || 0) == p) {
                                    if (qr(t, (null  == h.to ? f + 1 : h.to) - p, h.marker, null  == h.from),
                                    null  == h.to)
                                        return;
                                    h.to == p && (h = !1)
                                }
                            ...
                            for (var C = Math.min(f, v); ; ) {
                                ...
                                g = i.slice(o, o = n[m++]),
                                l = Fr(n[m++], t.cm.options)
                            }
                        }
                    else
                        for (var m = 1; m < n.length; m += 2)
                            t.addToken(t, i.slice(o, o = n[m]), Fr(n[m + 1], t.cm.options))
                }
                function Gr(e, t) {
                ...
                function $r(e, t, n, r) {
                    ...
                    if (t.full)
                        ...
                        if (1 == c.length)
                            o(u, u.text.slice(0, a.ch) + h + u.text.slice(s.ch), f);
                        else {
                            var m = l(1, c.length - 1);
                            m.push(new xl(h + u.text.slice(s.ch),f,r)),
                            o(u, u.text.slice(0, a.ch) + c[0], i(0)),
                            e.insert(a.line + 1, m)
                        }
                    else if (1 == c.length)
                        o(u, u.text.slice(0, a.ch) + c[0] + d.text.slice(s.ch), i(0)),
                        e.remove(a.line + 1, p);
                    else {
                        o(u, u.text.slice(0, a.ch) + c[0], i(0)),
                ...
                function ti(e) {
                    if (null  == e.parent)
                        return null ;
                    for (var t = e.parent, n = Ii(t.lines, e), r = t.parent; r; t = r,
                    r = r.parent)
                ...
                function ii(e) {
                    var t = e.order;
                    return null  == t && (t = e.order = la(e.text)),
                    t
                }
                function oi(e) {
                    this.done = [],
                ...
                function si(e, t) {
                    return t ? (ai(e.done),
                    Wi(e.done)) : e.done.length && !Wi(e.done).ranges ? Wi(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(),
                    Wi(e.done)) : void 0
                }
                function ci(e, t, n, r) {
                    var i = e.history;
                    ...
                    for (var r = 0, i = []; r < e.length; ++r) {
                        ...
                        if (o.ranges)
                            ...
                            for (var s = 0; s < l.length; ++s) {
                                ...
                                t)
                                    for (var d in u)
                                        (c = d.match(/^spans_(\d+)$/)) && Ii(t, Number(c[1])) > -1 && (Wi(a)[d] = u[d],
                                        delete u[d])
                            }
                        }
                    }
                    ...
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        if (o.ranges) {
                            ...
                            for (var a = 0; a < o.ranges.length; a++)
                                vi(o.ranges[a].anchor, t, n, r),
                                vi(o.ranges[a].head, t, n, r)
                        } else {
                            for (var a = 0; a < o.changes.length; ++a) {
                                var s = o.changes[a];
                                if (n < s.from.line)
                                    s.from = Fo(s.from.line + r, s.from.ch),
                                    s.to = Fo(s.to.line + r, s.to.ch);
                                else if (t <= s.to.line) {
                                    l = !1;
                                    break
                                }
                ...
                function Si(e, t) {
                    ...
                    if (r.length) {
                        ...
                        Uo ? i = Uo.delayedCallbacks : Il ? i = Il : (i = Il = [],
                        setTimeout(Li, 0));
                ...
                function Zi(e) {
                    if (null  == Kl) {
                        var t = _i("span", "​");
                        Ui(e, _i("span", [t, document.createTextNode("x")])),
                        0 != e.firstChild.offsetHeight && (Kl = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(xo && 8 > bo))
                    }
                ...
                function co(e, t) {
                    ...
                    for (var n, r = 0; r < e.length; ++r) {
                        ...
                        if (i.from == t || i.to == t) {
                            if (null  != n)
                                return so(e, i.level, e[n].level) ? (i.from != i.to && (oa = n),
                                r) : (i.from != i.to && (oa = r),
                                n);
                            n = r
                        }
                ...
                function uo(e, t, n, r) {
                    ...
                    do
                        t += n;
                    while (t > 0 && ji(e.text.charAt(t)));return t
                }
                function ho(e, t, n, r) {
                    var i = ii(e);
                    if (!i)
                    ...
                    for (var o = co(i, t), l = i[o], a = uo(e, t, l.level % 2 ? -n : n, r); ; ) {
                        if (a > l.from && a < l.to)
                            return a;
                        if (a == l.from || a == l.to)
                            return co(i, a) == o ? a : (l = i[o += n],
                            n > 0 == l.level % 2 ? l.to : l.from);
                        if (l = i[o += n],
                        !l)
                            return null ;
                ...
                m.prototype = Fi({
                    ...
                    zeroWidthHack: function() {
                        ...
                        this.disableHoriz = new Oi,
                        this.disableVert = new Oi
                    },
                ...
                L.prototype.finish = function() {
                    for (var e = 0; e < this.events.length; e++)
                        Wl.apply(null , this.events[e])
                }
                ;
                var Fo = e.Pos = function(e, t) {
                    return this instanceof Fo ? (this.line = e,
                    void (this.ch = t)) : new Fo(e,t)
                }
                ...
                ne.prototype = Fi({
                    init: function(e) {
                        function t(e) {
                            if (!Ti(r, e)) {
                                if (r.somethingSelected())
                                    ...
                                    var t = ee(r);
                                    Ro = t.text,
                                    "cut" == e.type ? r.setSelections(t.ranges, null , Pl) : (n.prevInput = "",
                                    o.value = t.text.join("\n"),
                                    _l(o))
                                }
                        ...
                        Al(o, "paste", function(e) {
                            Ti(r, e) || Q(e, r) || (r.state.pasteIncoming = !0,
                            n.fastPoll())
                        }),
                        Al(o, "cut", t),
                        Al(o, "copy", t),
                        Al(e.scroller, "paste", function(t) {
                    ...
                    showSelection: function(e) {
                        var t = this.cm
                          , n = t.display;
                        Ui(n.cursorDiv, e.cursors),
                        Ui(n.selectionDiv, e.selection),
                    ...
                    reset: function(e) {
                        if (!this.contextMenuPending) {
                            ...
                            if (r.somethingSelected()) {
                                ...
                                r.state.focused && _l(this.textarea),
                                xo && bo >= 9 && (this.hasSelection = l)
                            } else
                    ...
                    poll: function() {
                        var e = this.cm
                          , t = this.textarea
                          , n = this.prevInput;
                        if (this.contextMenuPending || !e.state.focused || ta(t) && !n && !this.composing || e.isReadOnly() || e.options.disableInput || e.state.keySeq)
                            return !1;
                        var r = t.value;
                        if (r == n && !e.somethingSelected())
                            return !1;
                        if (xo && bo >= 9 && this.hasSelection === r || Oo && /[\uf700-\uf7ff]/.test(r))
                        ...
                        for (var o = 0, l = Math.min(n.length, r.length); l > o && n.charCodeAt(o) == r.charCodeAt(o); )
                            ++o;
                        var a = this;
                    ...
                    onContextMenu: function(e) {
                        ...
                        if (a && !So) {
                            ...
                            if (l.style.cssText = "position: absolute; width: 30px; height: 30px; top: " + (e.clientY - h.top - 5) + "px; left: " + (e.clientX - h.left - 5) + "px; z-index: 1000; background: " + (xo ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);",
                            wo)
                                var f = window.scrollY;
                            if (o.input.focus(),
                            wo && window.scrollTo(null , f),
                            o.input.reset(),
                ...
                ie.prototype = Fi({
                        ...
                        function t(e) {
                            if (!Ti(r, e)) {
                                ...
                                if (e.clipboardData && !No)
                                    ...
                                    e.clipboardData.setData("text/plain", Ro.join("\n"));
                                else {
                                    var n = re()
                                      , i = n.firstChild;
                    ...
                    showPrimarySelection: function() {
                        ...
                        if (!n || n.bad || !r || r.bad || 0 != zo(X(n, r), t.from()) || 0 != zo(K(n, r), t.to())) {
                            ...
                            if (i || o) {
                                ...
                                e.addRange(u)),
                                a && null  == e.anchorNode ? e.addRange(a) : go && this.startGracePeriod()),
                    ...
                    showMultipleSelections: function(e) {
                        Ui(this.cm.display.cursorDiv, e.cursors),
                        Ui(this.cm.display.selectionDiv, e.selection)
                    },
                    ...
                    pollContent: function() {
                        ...
                        if (r.line < t.viewFrom || i.line > t.viewTo - 1)
                            return !1;
                        var o;
                        if (r.line == t.viewFrom || 0 == (o = zt(e, r.line)))
                            var l = ti(t.view[0].line)
                              , a = t.view[0].node;
                        else
                            var l = ti(t.view[o].line)
                        ...
                        for (var f = 0, p = 0, m = d[0], g = h[0], v = Math.min(m.length, g.length); v > f && m.charCodeAt(f) == g.charCodeAt(f); )
                            ++f;
                        for (var y = Wi(d), x = Wi(h), b = Math.min(y.length - (1 == d.length ? f : 0), x.length - (1 == h.length ? f : 0)); b > p && y.charCodeAt(y.length - p - 1) == x.charCodeAt(x.length - p - 1); )
                            ++p;
                        d[d.length - 1] = y.slice(0, y.length - p),
                        d[0] = d[0].slice(f);
                        var w = Fo(l, f)
                          , k = Fo(c, h.length ? Wi(h).length - p : 0);
                        return d.length > 1 || d[0] || zo(w, k) ? (Wn(e.doc, d, w, k, "+input"),
                        !0) : void 0
                    },
                    ensurePolled: function() {
                    ...
                    onKeyPress: function(e) {
                        e.preventDefault(),
                        this.cm.isReadOnly() || Ot(this.cm, Z)(this.cm, String.fromCharCode(null  == e.charCode ? e.keyCode : e.charCode), 0)
                    },
                    readOnlyChanged: function(e) {
                ...
                ue.prototype = {
                    ...
                    equals: function(e) {
                        ...
                        for (var t = 0; t < this.ranges.length; t++) {
                            var n = this.ranges[t]
                              , r = e.ranges[t];
                            if (0 != zo(n.anchor, r.anchor) || 0 != zo(n.head, r.head))
                                return !1
                        }
                        return !0
                    },
                    deepCopy: function() {
                        for (var e = [], t = 0; t < this.ranges.length; t++)
                            e[t] = new de(V(this.ranges[t].anchor),V(this.ranges[t].head));
                ...
                e.prototype = {
                    ...
                    setOption: function(e, t) {
                        var n = this.options
                          , r = n[e];
                        n[e] == t && "mode" != e || (n[e] = t,
                        el.hasOwnProperty(e) && Ot(this, el[e])(this, t, r))
                    },
                    ...
                    indentLine: Ht(function(e, t, n) {
                        ...
                        ve(this.doc, e) && Bn(this, e, t, n)
                    }),
                    indentSelection: Ht(function(e) {
                        for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                            var i = t[r];
                            if (i.empty())
                                i.head.line > n && (Bn(this, i.head.line, e, !0),
                                n = i.head.line,
                    ...
                    clearGutter: Ht(function(e) {
                        ...
                        n.iter(function(n) {
                            ...
                            Pt(t, r, "gutter"),
                            Bi(n.gutterMarkers) && (n.gutterMarkers = null )),
                            ++r
                        })
                    }),
                    lineInfo: function(e) {
                    ...
                    addWidget: function(e, t, n, r, i) {
                        ...
                        t.style.left = a + "px"),
                        n && Dn(this, a, l, a + t.offsetWidth, l + t.offsetHeight)
                    },
                    ...
                    findPosH: function(e, t, n, r) {
                        ...
                        0 > t && (i = -1,
                        t = -t);
                        for (var o = 0, l = me(this.doc, e); t > o && (l = qn(this.doc, l, i, n, r),
                        !l.hitSide); ++o)
                            ;
                        return l
                    },
                    ...
                    moveV: Ht(function(e, t) {
                        ...
                        if (r.extendSelectionsBy(function(l) {
                            ...
                            i.push(a.left);
                            var s = Un(n, a, e, t);
                            return "page" == t && l == r.sel.primary() && Fn(n, null , ht(n, s, "div").top - a.top),
                            s
                        }, zl),
                        i.length)
                    ...
                    refresh: Ht(function() {
                        ...
                        u(this),
                        (null  == e || Math.abs(e - yt(this.display)) > .5) && l(this),
                        Wl(this, "refresh", this)
                    }),
                ...
                Gn("lineSeparator", null , function(e, t) {
                    ...
                    t) {
                        ...
                        for (var i = n.length - 1; i >= 0; i--)
                            Wn(e.doc, t, n[i], Fo(n[i].line, n[i].ch + t.length))
                    }
                }),
                ...
                Gn("showCursorWhenSelecting", !1, Ee, !0),
                ...
                Gn("cursorHeight", 1, Ee, !0),
                Gn("singleCursorHeightPerLine", !0, Ee, !0),
                Gn("workTime", 100),
                Gn("workDelay", 100),
                ...
                e.resolveMode = function(t) {
                    if ("string" == typeof t && rl.hasOwnProperty(t))
                        t = rl[t];
                    ...
                    transposeChars: function(e) {
                        At(e, function() {
                            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++) {
                                ...
                                if (o)
                                    if (i.ch == o.length && (i = new Fo(i.line,i.ch - 1)),
                                    i.ch > 0)
                                        i = new Fo(i.line,i.ch + 1),
                                        e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), Fo(i.line, i.ch - 2), i, "+transpose");
                ...
                ul["default"] = Oo ? ul.macDefault : ul.pcDefault,
                ...
                var dl = e.lookupKey = function(e, t, n, r) {
                  ...
                  , fl = e.keyName = function(e, t) {
                    if (So && 34 == e.keyCode && e["char"])
                        return !1;
                    var n = ia[e.keyCode]
                      , r = n;
                    return null  == r || e.altGraphKey ? !1 : (e.altKey && "Alt" != n && (r = "Alt-" + r),
                    (Io ? e.metaKey : e.ctrlKey) && "Ctrl" != n && (r = "Ctrl-" + r),
                    (Io ? e.ctrlKey : e.metaKey) && "Cmd" != n && (r = "Cmd-" + r),
                ...
                pl.prototype = {
                    ...
                    column: function() {
                        return this.lastColumnPos < this.start && (this.lastColumnValue = Rl(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue),
                        this.lastColumnPos = this.start),
                        this.lastColumnValue - (this.lineStart ? Rl(this.string, this.lineStart, this.tabSize) : 0)
                    },
                ...
                gl.prototype.clear = function() {
                    if (!this.explicitlyCleared) {
                        ...
                        for (var r = null , i = null , o = 0; o < this.lines.length; ++o) {
                            ...
                            e && !this.collapsed ? Pt(e, ti(l), "text") : e && (null  != a.to && (i = ti(l)),
                            null  != a.from && (r = ti(l))),
                            l.markedSpans = tr(l.markedSpans, a),
                            null  == a.from && this.collapsed && !kr(this.doc, l) && e && ei(l, yt(e.display))
                        }
                ...
                gl.prototype.find = function(e, t) {
                    ...
                    for (var n, r, i = 0; i < this.lines.length; ++i) {
                        ...
                        if (null  != l.from && (n = Fo(t ? o : ti(o), l.from),
                        -1 == e))
                            return n;
                        if (null  != l.to && (r = Fo(t ? o : ti(o), l.to),
                        1 == e))
                            return r
                    }
                    return n && {
                ...
                gl.prototype.detachLine = function(e) {
                    if (this.lines.splice(Ii(this.lines, e), 1),
                ...
                var kl = 0
                  , Cl = e.Doc = function(e, t, n, r) {
                    ...
                    null  == n && (n = 0),
                    Kr.call(this, [new Vr([new xl("",null )])]),
                    this.first = n,
                ...
                Cl.prototype = Pi(Kr.prototype, {
                    ...
                    replaceSelections: Wt(function(e, t, n) {
                        ...
                        for (var a = t && "end" != t && Sn(this, r, t), o = r.length - 1; o >= 0; o--)
                            Tn(this, r[o]);
                ...
                for (var Ll in Cl.prototype)
                    Cl.prototype.hasOwnProperty(Ll) && Ii(Sl, Ll) < 0 && (e.prototype[Ll] = function(e) {
                        return function() {
                ...
                var ql, Ul = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, Gl = e.isWordChar = function(e) {
                ...
                !function() {
                    for (var e = 0; 10 > e; e++)
                        ia[e + 48] = ia[e + 96] = String(e);
                    for (var e = 65; 90 >= e; e++)
                        ia[e] = String.fromCharCode(e);
                    for (var e = 1; 12 >= e; e++)
                        ia[e + 111] = ia[e + 63235] = "F" + e
                }();
                var oa, la = function() {
                    function e(e) {
                    ...
                    return function(n) {
                        if (!i.test(n))
                            return !1;
                        for (var r, u = n.length, d = [], h = 0; u > h; ++h)
                        ...
                        for (var h = 0, p = c; u > h; ++h) {
                            var r = d[h];
                            "1" == r && "r" == p ? d[h] = "n" : l.test(r) && (p = r,
                            "r" == r && (d[h] = "R"))
                        }
                        for (var h = 1, f = d[0]; u - 1 > h; ++h) {
                            var r = d[h];
                            "+" == r && "1" == f && "1" == d[h + 1] ? d[h] = "1" : "," != r || f != d[h + 1] || "1" != f && "n" != f || (d[h] = f),
                            f = r
                        }
                        for (var h = 0; u > h; ++h) {
                            var r = d[h];
                            if ("," == r)
                                ...
                                for (var m = h + 1; u > m && "%" == d[m]; ++m)
                                    ;
                                for (var g = h && "!" == d[h - 1] || u > m && "1" == d[m] ? "1" : "N", v = h; m > v; ++v)
                                    d[v] = g;
                                h = m - 1
                            }
                        }
                        ...
                        for (var h = 0; u > h; ++h)
                            if (o.test(d[h])) {
                                for (var m = h + 1; u > m && o.test(d[m]); ++m)
                                    ;
                                for (var y = "L" == (h ? d[h - 1] : c), x = "L" == (u > m ? d[m] : c), g = y || x ? "L" : "R", v = h; m > v; ++v)
                                    d[v] = g;
                                h = m - 1
                            }
                        for (var b, w = [], h = 0; u > h; )
                        ...
                        w[0].level != Wi(w).level && w.push(new t(w[0].level,u,u)),
                        w
                    }
                }();
                return e.version = "5.12.1",
                e
            })
        }
        , {}],
                      ...
                      , l = {
                        ...
                        token: function(e, n) {
                            ...
                            if ("`" === e.peek()) {
                                ...
                                e.eatWhile("`");
                                var l = 1 + e.pos - i;
                                return n.code ? l === o && (n.code = !1) : (o = l,
                                n.code = !0),
                                null 
                            }
                            if (n.code)
                ...
                e.defineMode("markdown", function(t, n) {
                    ...
                    function s(e, t) {
                        var o = e.sol()
                          ...
                          , s = t.indentedCode;
                        t.indentedCode = !1,
                        a && (t.indentationDiff >= 0 ? (t.indentationDiff < 4 && (t.indentation -= t.indentationDiff),
                        t.list = null ) : t.indentation > 0 ? t.list = null  : t.list = !1);
                        var c = null ;
                        if (t.indentationDiff >= 4)
                            return e.skipToEnd(),
                            s || l(t.prevLine) ? (t.indentation -= 4,
                            t.indentedCode = !0,
                            S.code) : null ;
                        if (e.eatSpace())
                            return null ;
                        if ((c = e.match(O)) && c[1].length <= 6)
                            return t.header = c[1].length,
                            n.highlightFormatting && (t.formatting = "header"),
                            t.f = t.inline,
                            h(t);
                        if (!(l(t.prevLine) || t.quote || a || s) && (c = e.match(H)))
                            return t.header = "=" == c[0].charAt(0) ? 1 : 2,
                            n.highlightFormatting && (t.formatting = "header"),
                            t.f = t.inline,
                            h(t);
                        if (e.eat(">"))
                            return t.quote = o ? 1 : t.quote + 1,
                        ...
                        if ((l(t.prevLine) || a) && (e.match(M, !1) || e.match(N, !1))) {
                            var d = null ;
                            for (e.match(M, !0) ? d = "ul" : (e.match(N, !0),
                            d = "ol"),
                            t.indentation = e.column() + e.current().length,
                            t.list = !0; t.listStack && e.column() < t.listStack[t.listStack.length - 1]; )
                                t.listStack.pop();
                            return t.listStack.push(t.indentation),
                            n.taskLists && e.match(A, !1) && (t.taskList = !0),
                            t.f = t.inline,
                            n.highlightFormatting && (t.formatting = ["list", "list-" + d]),
                            h(t)
                        }
                        return n.fencedCodeBlocks && (c = e.match(I, !0)) ? (t.fencedChars = c[1],
                        t.localMode = r(c[2]),
                    ...
                    function p(t, r) {
                        ...
                        if (r.taskList) {
                            ...
                            return l ? r.taskOpen = !0 : r.taskClosed = !0,
                    ...
                    function v(e) {
                        return function(t, r) {
                            ...
                            return t.match(w(e), !0) && t.backUp(1),
                            r.linkHref = !0,
                            h(r)
                        }
                    }
                    ...
                    for (var L in S)
                        S.hasOwnProperty(L) && n.tokenTypeOverrides[L] && (S[L] = n.tokenTypeOverrides[L]);
                    var T = /^([*\-_])(?:\s*\1){2,}\s*$/
                      , M = /^[*\-+]\s+/
                      , N = /^[0-9]+([.)])\s+/
                      , A = /^\[(x| )\](?=\s)/
            ...
            !function(i) {
                ...
                e.defineMode("xml", function(r, i) {
                    ...
                    function m(e, t, n) {
                        if ("word" == e) {
                            var r = t.current();
                            return n.context && n.context.tagName != r && C.implicitlyClosed.hasOwnProperty(n.context.tagName) && d(n),
                            n.context && n.context.tagName == r || C.matchClosing === !1 ? (M = "tag",
                            g) : (M = "tag error",
                            v)
                        }
                        return M = "error",
                    ...
                    function y(e, t, n) {
                        ...
                        if ("endTag" == e || "selfcloseTag" == e) {
                            ...
                            "selfcloseTag" == e || C.autoSelfClosers.hasOwnProperty(r) ? h(n, r) : (h(n, r),
                    ...
                    function x(e, t, n) {
                        return "equals" == e ? b : (C.allowMissing || (M = "error"),
                        y(e, t, n))
                    }
                    function b(e, t, n) {
                        return "string" == e ? w : "word" == e && C.allowUnquoted ? (M = "string",
                        y) : (M = "error",
                        y(e, t, n))
                    }
                    function w(e, t, n) {
                ...
                (function() {
                    ...
                    function h(e, n, r) {
                        if (r || "function" == typeof n) {
                            ...
                            for (; c < i.length; c++)
                                !function(e) {
                                    return "code" !== e.type ? --o || f() : s(e.text, e.lang, function(t, n) {
                                        return t ? f(t) : null  == n || n === e.text ? --o || f() : (e.text = n,
                                        e.escaped = !0,
                                        void (--o || f()))
                                    })
                                }(i[c])
                            ...
                            try {
                                return n && (n = d({}, h.defaults, n)),
                                l.parse(t.lex(e, n), n)
                            } catch (u) {
                                if (u.message += "\nPlease report this to https://github.com/chjj/marked.",
                                (n || h.defaults).silent)
                                    return "<p>An error occured:</p><pre>" + a(u.message + "", !0) + "</pre>";
                                throw u
                            }
                    }
                    var f = {
                    ...
                    f.bullet = /(?:[*+-]|\d+\.)/,
                    f.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/,
                    f.item = c(f.item, "gm")(/bull/g, f.bullet)(),
                    f.list = c(f.list)(/bull/g, f.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + f.def.source + ")")(),
                    f.blockquote = c(f.blockquote)("def", f.def)(),
                    ...
                    f.html = c(f.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, f._tag)(),
                    f.paragraph = c(f.paragraph)("hr", f.hr)("heading", f.heading)("lheading", f.lheading)("blockquote", f.blockquote)("tag", "<" + f._tag)("def", f.def)(),
                    f.normal = d({}, f),
                    f.gfm = d({}, f.normal, {
                        fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,
                        paragraph: /^/,
                    ...
                    f.gfm.paragraph = c(f.paragraph)("(?!", "(?!" + f.gfm.fences.source.replace("\\1", "\\2") + "|" + f.list.source.replace("\\1", "\\3") + "|")(),
                    f.tables = d({}, f.gfm, {
                        nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
                        table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
                    }),
                        ...
                        for (var r, i, o, l, a, s, c, u, d, e = e.replace(/^ +$/gm, ""); e; )
                            ...
                            o = this.rules.code.exec(e))
                                ...
                                u = 0; d > u; u++)
                                    ...
                                    this.options.smartLists && u !== d - 1 && (a = f.bullet.exec(o[u + 1])[0],
                                    l === a || l.length > 1 && a.length > 1 || (e = o.slice(u + 1).join("\n") + e,
                                    u = d - 1)),
                                    i = r || /\n\n(?!\s*$)/.test(s),
                                    u !== d - 1 && (r = "\n" === s.charAt(s.length - 1),
                                    i || (i = r)),
                    ...
                    i.prototype.output = function(e) {
                        for (var t, n, r, i, o = ""; e; )
                            if (i = this.rules.escape.exec(e))
                                ...
                                r = this.mangle("mailto:") + n) : (n = a(i[1]),
                                r = n),
                                ...
                                if (i = this.rules.tag.exec(e))
                                    ...
                                    e = e.substring(i[0].length),
                                    o += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : a(i[0]) : i[0];
                                    ...
                                    e = e.substring(i[0].length),
                                    o += this.renderer.codespan(a(i[2], !0));
                                    ...
                                    e = e.substring(i[0].length),
                                    o += this.renderer.text(a(this.smartypants(i[0])));
                                else if (e)
                                    throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                            } else
                                e = e.substring(i[0].length),
                    ...
                    l.prototype.tok = function() {
                        ...
                        case "list_start":
                            for (var l = "", a = this.token.ordered; "list_end" !== this.next().type; )
                                l += this.tok();
        ...
        14: [function(e, t, n) {
            ...
            function i(e, t, n) {
                ...
                e.title && t && (r.title = l(e.title, e.action, n),
                _ && (r.title = r.title.replace("Ctrl", "⌘"),
            ...
            function a(e, t) {
                ...
                if (!n.type)
                    return {};
                for (var r, i, o = n.type.split(" "), l = {}, a = 0; a < o.length; a++)
                    r = o[a],
                    "strong" === r ? l.bold = !0 : "variable-2" === r ? (i = e.getLine(t.line),
                    /^\s*\d+\.\s/.test(i) ? l["ordered-list"] = !0 : l["unordered-list"] = !0) : "atom" === r ? l.quote = !0 : "em" === r ? l.italic = !0 : "quote" === r ? l.quote = !0 : "strikethrough" === r ? l.strikethrough = !0 : "comment" === r ? l.code = !0 : "link" === r ? l.link = !0 : "tag" === r ? l.image = !0 : r.match(/^header(\-[1-6])?$/) && (l[r.replace("header", "heading")] = !0);
                return l
            }
            function s(e) {
                var t = e.codemirror;
            ...
            function h(e) {
                ...
                var o, l, a, s = e.options.blockStyles.code, c = e.codemirror, u = c.getCursor("start"), d = c.getCursor("end"), h = c.getTokenAt({
                    line: u.line,
                    ch: u.ch || 1
                }), f = c.getLineHandle(u.line), p = r(c, u.line, f, h);
                if ("single" === p) {
                    ...
                    if (u.line !== d.line || u.ch !== d.ch) {
                        for (o = u.line; o >= 0 && (f = c.getLineHandle(o),
                        !t(f)); o--)
                            ;
                        ...
                        y = u.line - 1) : (v = k + "\n",
                        y = u.line),
                        t(c.getLineHandle(d.line)) ? (x = "",
                        b = d.line,
                        0 === d.ch && (b += 1)) : 0 !== d.ch && t(c.getLineHandle(d.line + 1)) ? (x = "",
                        b = d.line + 1) : (x = k + "\n",
                        b = d.line + 1),
                        0 === d.ch && (b -= 1),
                        ...
                        C = u.line - 1)),
                        void 0 === o)
                            for (o = C; o >= 0 && (f = c.getLineHandle(o),
                            !t(f)); o--)
                                ;
                        if (void 0 === l)
                            for (a = c.lineCount(),
                            l = C; a > l && (f = c.getLineHandle(l),
                            !t(f)); l++)
                                ;
                        c.operation(function() {
                            c.replaceRange("", {
                    ...
                    if (u.line !== d.line || u.ch !== d.ch)
                        ...
                        for (o = u.line; o >= 0; o--)
                            if (f = c.getLineHandle(o),
                            !f.text.match(/^\s*$/) && "indented" !== r(c, o, f)) {
                                o += 1;
                                break
                            }
                        for (a = c.lineCount(),
                        l = u.line; a > l; l++)
                            if (f = c.getLineHandle(l),
                            !f.text.match(/^\s*$/) && "indented" !== r(c, l, f)) {
                                l -= 1;
                                break
                            }
                    }
            ...
            function k(e) {
                ...
                !i) ? !1 : void O(t, n.link, r.insertTexts.link, i)
            }
            function C(e) {
                var t = e.codemirror
                  , n = a(t)
                ...
                !i) ? !1 : void O(t, n.image, r.insertTexts.image, i)
            }
            function S(e) {
                var t = e.codemirror
                  , n = a(t)
            ...
            function O(e, t, n, r) {
                if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) {
                    var i, o = n[0], l = n[1], a = e.getCursor("start"), s = e.getCursor("end");
                    r && (l = l.replace("#url#", r)),
                    t ? (i = e.getLine(a.line),
                    o = i.slice(0, a.ch),
                    l = i.slice(a.ch),
                    e.replaceRange(o + l, {
                        line: a.line,
            ...
            function I(e, t, n, r) {
                if (!/editor-preview-active/.test(e.codemirror.getWrapperElement().lastChild.className)) {
                    ...
                    var i, o = e.codemirror, l = a(o), s = n, c = r, u = o.getCursor("start"), d = o.getCursor("end");
                    l[t] ? (i = o.getLine(u.line),
                    s = i.slice(0, u.ch),
                    c = i.slice(u.ch),
                    ...
                    u !== d && (d.ch -= 2)) : "italic" == t && (u.ch -= 1,
                    u !== d && (d.ch -= 1))) : (i = o.getSelection(),
            ...
            function z(e) {
                ...
                if (t) {
                    ...
                    i.rel = "stylesheet",
                    i.href = "../css/font-awesome.min.css",
                ...
                e.insertTexts = P({}, X, e.insertTexts || {}),
                e.promptTexts = Y,
                e.blockStyles = P({}, Z, e.blockStyles || {}),
                e.shortcuts = P({}, U, e.shortcuts || {}),
            ...
            z.prototype.render = function(e) {
                ...
                !this._rendered || this._rendered !== e) {
                    ...
                    var l, a;
                    if (t.spellChecker !== !1 ? (l = "spell-checker",
                    a = t.parsingConfig,
                    a.name = "gfm",
                    a.gitHubSpice = !1) : (l = t.parsingConfig,
                    l.name = "gfm",
                    l.gitHubSpice = !1),
                    this.codemirror = B.fromTextArea(e, {
                        mode: l,
                        backdrop: a,
                        theme: "paper",
            ...
            z.prototype.createToolbar = function(e) {
                ...
                e && 0 !== e.length) {
                        ...
                        if (("guide" != e[t].name || r.options.toolbarGuideIcon !== !1) && !(r.options.hideIcons && -1 != r.options.hideIcons.indexOf(e[t].name) || ("fullscreen" == e[t].name || "side-by-side" == e[t].name) && $())) {
                            if ("|" === e[t]) {
                                for (var s = !1, c = t + 1; c < e.length; c++)
                                    console.log(c),
                                    "|" === e[c] || r.options.hideIcons && -1 != r.options.hideIcons.indexOf(e[c].name) || (console.log(e[c]),
                                    s = !0);
                                if (!s)
                                    continue
                            }
                            !function(e) {
                                ...
                                e.action && ("function" == typeof e.action ? t.onclick = function() {
                                    e.action(r)
                                }
                    ...
                    return d.parentNode.insertBefore(n, d),
                    n
                }
            }
            ,
            z.prototype.createStatusbar = function(e) {
                ...
                if (e && 0 !== e.length) {
                    ...
                    return d.parentNode.insertBefore(s, d.nextSibling),
                    s
                }
            }
            ,
            ...
            z.toggleBold = c,
            z.toggleItalic = u,
            z.toggleStrikethrough = d,
            z.toggleBlockquote = f,
            z.toggleHeadingSmaller = p,
            z.toggleHeadingBigger = m,
            z.toggleHeading1 = g,
            z.toggleHeading2 = v,
            z.toggleHeading3 = y,
            z.toggleCodeBlock = h,
            z.toggleUnorderedList = x,
            z.toggleOrderedList = b,
            z.cleanBlock = w,
            z.drawLink = k,
            z.drawImage = C,
            z.drawTable = S,
            z.drawHorizontalRule = L,
            z.undo = T,
            z.redo = M,
            z.togglePreview = A,
            z.toggleSideBySide = N,
            z.toggleFullScreen = s,
            z.prototype.toggleBold = function() {
                c(this)
            }
            ,
            ...
            z.prototype.toTextArea = function() {
                var e = this.codemirror
                  , t = e.getWrapperElement();
                t.parentNode.removeChild(this.gui.toolbar),
